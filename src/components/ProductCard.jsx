  ...
  return (
    <div className="grid grid-cols-1">
      ...
      <div className="relative flex items-center justify-center p-10 bg-[#F5F5F5] h-[250px] rounded-[4px] overflow-hidden group">
        <span className="absolute top-2 left-2 z-10 rounded-[4px] bg-secondary-2 text-white py-1 px-3">-32%</span>
        ...
        <img className="w-full" src={cardImage_2} alt="image" />
...
{/* Text */}
      <div className="pt-4">
        ...
        <p>$<span>960</span> $<del>1160</del> </p>
